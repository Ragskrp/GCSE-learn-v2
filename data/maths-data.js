...
Think of a pizza cut into slices. If you have 1 slice out of 8, that's $1/8$.

![Fractions Pizza Intro](/lessons/fractions/fractions_pizza_intro_1770480108741.png)

## ⚖️ Equivalent Fractions
Fractions that look different but have the same value.
e.g., $1/2 = 2/4 = 4/8$.

![Equivalent Fractions Bars](/lessons/fractions/equivalent_fractions_bars_1770480164893.png)

## ➕ Adding Fractions
To add fractions, you need a **Common Denominator**.
$1/4 + 1/4 = 2/4 = 1/2$.

![Adding Fractions Visual](/lessons/fractions/adding_fractions_visual_1770480210085.png)

## ✖️ Multiplying Fractions
Multiply the tops (numerators) and multiply the bottoms (denominators).
$1/2 \times 1/2 = 1/4$.

![Multiplying Fractions Area Model](/lessons/fractions/multiplying_fractions_area_1770480282054.png)
